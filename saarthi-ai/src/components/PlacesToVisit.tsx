  ...
  const places = [
    {
      ...
      name: "Historic Fort",
      image:
        "https://images.unsplash.com/photo-1756468288062-bfa87b7cefcc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmYW1vdXMlMjBsYW5kbWFya3MlMjB0b3VyaXN0fGVufDF8fHx8MTc2MjE0MTE5Mnww&ixlib=rb-4.1.0&q=80&w=1080",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {places.map((place, index) => (
            <div
              ...
              style={{
                transform: `rotate(${[1, -0.5, 0.8, -1, 0.5, -0.3][index]}deg)`,
              }}
            >
